...
<div class="admin-layout">
    <aside class="admin-sidebar">
        ...
        <nav class="admin-nav">
            <a href="index" class="active"><i class="fas fa-chart-line"></i> Dashboard</a>
    ...
    <main class="admin-main">
        <div class="admin-header-top">
            ...
            <div style="display:flex;gap:12px">
                <a href="orders" class="btn btn-outline" style="font-size:.65rem;padding:10px 20px">
                    <i class="fas fa-bell"></i> <?= $pendingOrders ?> pendientes
                </a>
                <a href="products?action=add" class="btn btn-gold" style="font-size:.65rem;padding:10px 20px">
        ...
        <div class="quick-actions">
            ...
            <a href="orders?status=pending" class="btn btn-dark">
                <i class="fas fa-clock"></i> Ver Pendientes
            </a>
            <a href="settings" class="btn btn-dark">
