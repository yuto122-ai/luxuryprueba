            ...
            foreach ($allColors as $c) {
                ...
                if (!empty($colorImages['name'][$colorId])) {
                    ...
                    if (in_array($ext, ['jpg','jpeg','png','webp'])) {
                        // Use a unique file name each upload to avoid mobile/browser stale cache.
                     ...
                     // Some old databases may not have UNIQUE(product_id,color_id), so ON DUPLICATE is unreliable.
                     ...
                     if ($existingId) {
                          ...
                          // Keep only the latest row for this product/color pair.
