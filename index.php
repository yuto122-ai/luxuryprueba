...
<head>
    ...
    <style>
        ...
        .viewer-sizes{display:flex;flex-wrap:wrap;gap:8px;margin:16px 0;position:relative;z-index:10002}
        .viewer-size-btn{
...
<aside class="cart-sidebar" id="cart-sidebar">
    ...
    <div class="cart-footer">
        ...
        <a href="checkout.php" class="btn btn-gold" style="width:100%;justify-content:center">Proceder al Pago <i class="fas fa-arrow-right"></i></a>
        ...
        <div class="pack-grid reveal">
            ...
            <div class="wholesale-pack-card">
                ...
                <div style="display:flex;gap:12px;margin-top:24px">
                    <button class="btn btn-gold" onclick="open360Viewer(<?= $prod['id'] ?>)" style="flex:1;justify-content:center;font-size:.65rem"><i class="fas fa-cube"></i> Ver 360°</button>
        ...
        <div class="product-card" data-material="<?= $prod['material'] ?>" data-featured="<?= $prod['featured']?'true':'false' ?>">
            <div class="product-img-wrap">
                ...
                <div class="product-actions">
                    <button class="btn btn-gold" onclick="open360Viewer(<?= $prod['id'] ?>)" style="flex:1;justify-content:center;font-size:.62rem;padding:10px"><i class="fas fa-cube"></i> Vista 360°</button>
                    <button class="btn btn-outline" onclick="open360Viewer(<?= $prod['id'] ?>)" style="justify-content:center;padding:10px 14px"><i class="fas fa-plus"></i></button>
                </div>
            </div>
    ...
    <div class="footer-grid">
        <div class="footer-brand">
            ...
            <div style="display:flex;gap:16px;margin-top:24px">
                ...
                <a href="#" style="width:40px;height:40px;border:1px solid rgba(255,255,255,.1);display:flex;align-items:center;justify-content:center;color:var(--gray);font-size:.9rem;text-decoration:none;transition:var(--transition)" onmouseover="this.style.borderColor='var(--gold)';this.style.color='var(--gold)'" onmouseout="this.style.borderColor='rgba(255,255,255,.1)';this.style.color='var(--gray)'"><i class="<?= $icon ?>"></i></a>
                <?php endforeach; ?>
            </div>
        </div>
        <div class="footer-col"><h4>Tienda</h4><ul><li><a href="#mayoreo">Venta Mayoreo</a></li><li><a href="#individual">Tienda Individual</a></li><li><a href="catalog.php">Catálogo</a></li><li><a href="login.php">Mi Cuenta</a></li></ul></div>
        ...
        <div class="footer-col"><h4>Contacto</h4><ul><li><a href="mailto:contacto@blackclothes.mx"><i class="fas fa-envelope" style="width:16px;color:var(--gold)"></i> contacto@blackclothes.mx</a></li><li><a href="https://wa.me/521XXXXXXXXXX"><i class="fab fa-whatsapp" style="width:16px;color:var(--gold)"></i> WhatsApp</a></li></ul></div>
    </div>
...
window.open360Viewer = function(productId) {
    ...
    document.getElementById('viewer-price').textContent    = '$'+parseFloat(prod.price_individual||prod.price_wholesale||0).toFixed(2);
    ...
    if (prod.sizes && prod.sizes.length > 0) {
        prod.sizes.forEach(function(sz) {
            ...
            btn.addEventListener('click', function(e) {
                e.stopPropagation();
                sizesEl.querySelectorAll('.viewer-size-btn').forEach(function(b){b.classList.remove('selected');});
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Neutralizar el listener de main.js que cierra el viewer al hacer click en viewer-360
    // (main.js usa: if (e.target === viewer360) close360Viewer() — stopPropagation lo bloquea)
});
